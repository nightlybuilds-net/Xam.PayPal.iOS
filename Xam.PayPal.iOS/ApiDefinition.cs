...
namespace Xam.PayPal.iOS
{
	...
	{
		// @property (assign, readwrite, nonatomic) BOOL keepStatusBarStyleForCardIO;
		[Export("keepStatusBarStyleForCardIO")]
		bool KeepStatusBarStyleForCardIO();// { get; set; }

		// @property (assign, readwrite, nonatomic) UIBarStyle navigationBarStyleForCardIO;
		[Export("navigationBarStyleForCardIO", ArgumentSemantic.Assign)]
		UIBarStyle NavigationBarStyleForCardIO();// { get; set; }

		// @property (readwrite, retain, nonatomic) UIColor * navigationBarTintColorForCardIO;
		[Export("navigationBarTintColorForCardIO", ArgumentSemantic.Retain)]
		UIColor NavigationBarTintColorForCardIO();// { get; set; }
	}
